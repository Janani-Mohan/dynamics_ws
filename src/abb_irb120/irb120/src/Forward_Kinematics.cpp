...
MatrixXd ForwardKinematics::InverseKinematics(MatrixXd H)
{
  ...
  JointAngles(0,0)=theta1;//*(180.0/M_PI);
  JointAngles(0,1)=theta2;//*(180.0/M_PI);
  JointAngles(0,2)=theta3;//*(180.0/M_PI);
  JointAngles(0,3)=theta4;//*(180.0/M_PI);
  JointAngles(0,4)=theta5;//*(180.0/M_PI);
  JointAngles(0,5)=theta6;//*(180.0/M_PI);
//  moveRobot(JointAngles);
  return JointAngles;
}

MatrixXd ForwardKinematics::getHomogeneous()
{
  Matrix4d T06;
  MatrixXd T01;
  MatrixXd T12;
  ...
  T01 = MatrixTransformation(theta(0),d(0),a(0),alpha(0));
  T12 = MatrixTransformation(theta(1),d(1),a(1),alpha(1));
  T23 = MatrixTransformation(theta(2),d(2),a(2),alpha(2));
  T34 = MatrixTransformation(theta(3),d(3),a(3),alpha(3));
  T45 = MatrixTransformation(theta(4),d(4),a(4),alpha(4));
  T56 = MatrixTransformation(theta(5),d(5),a(5),alpha(5));
...
for(int i = 0; i<1000;i++)
{
  ...
  moveRobot(angles);
  loop_rate.sleep();
  // cout<<Angles2(i,5)*180/M_PI<<endl;
}
